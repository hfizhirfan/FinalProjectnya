    ...
    <section id="menu" class="bg-light">
        ...
        <div class="container">
            <ul class="nav nav-pills mb-4 justify-content-center" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Mie-tab" data-bs-toggle="pill" data-bs-target="#pills-Mie"
                        type="button" role="tab" aria-controls="pills-Mie" aria-selected="true">
                        Mie
                    </button>
                </li>

                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Sayur-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-Sayur" type="button" role="tab" aria-controls="pills-Sayur"
                        aria-selected="true">
                        Sayur
                    </button>
                </li>
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Ayam-tab" data-bs-toggle="pill" data-bs-target="#pills-Ayam"
                        type="button" role="tab" aria-controls="pills-Ayam" aria-selected="true">
                        Ayam
                    </button>
                </li>

                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Ikan-tab" data-bs-toggle="pill" data-bs-target="#pills-Ikan"
                        type="button" role="tab" aria-controls="pills-Ikan" aria-selected="true">
                        Ikan
                    </button>
                </li>

                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Daging-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-Daging" type="button" role="tab" aria-controls="pills-Daging"
                        aria-selected="true">
                        Daging
                    </button>
                </li>
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Nasi-tab" data-bs-toggle="pill" data-bs-target="#pills-Nasi"
                        type="button" role="tab" aria-controls="pills-Nasi" aria-selected="true">
                        Nasi
                    </button>
                </li>

                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Soto-tab" data-bs-toggle="pill" data-bs-target="#pills-Soto"
                        type="button" role="tab" aria-controls="pills-Soto" aria-selected="true">
                        Soto
                    </button>
                </li>

                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-Puding-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-Puding" type="button" role="tab" aria-controls="pills-Puding"
                        aria-selected="true">
                        Puding
                    </button>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-all" role="tabpanel"
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Sayur/Sayur Labu Siam D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <div>
                                        <span>Rated(5.4)</span>
                                        <span class="stars">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Ikan/Ikan Patin Tempoyak D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <div>
                                        <span>Rated(5.4)</span>
                                        <span class="stars">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Daging/Daging Sop Konro D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <div>
                                        <span>Rated(5.4)</span>
                                        <span class="stars">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Nasi/Nasi Ayam Hainan D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <div>
                                        <span>Rated(5.4)</span>
                                        <span class="stars">
                ...
                <div class="tab-pane fade show" id="pills-Mie" role="tabpanel" aria-labelledby="pills-Mie-tab"
                    tabindex="0">
                    <!--Mie-->
                    <div class="row gy-4">
                        <div class="col-lg-3 col-sm-6">
                ...
                <!--katagori tiap menu-->
                <!--Sayur-->
                <div class="tab-pane fade show" id="pills-Sayur" role="tabpanel" aria-labelledby="pills-Sayur-tab"
                    tabindex="0">
                    <div class="row gy-4">
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Sayur/Sayur Daun Singkong D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                ...
                <!--Ayam-->
                <div class="tab-pane fade show" id="pills-Ayam" role="tabpanel" aria-labelledby="pills-Ayam-tab"
                    tabindex="0">
                    <div class="row gy-4">
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                ...
                <div class="tab-pane fade show" id="pills-Ikan" role="tabpanel" aria-labelledby="pills-Ikan-tab"
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Ikan/Ikan Bandeng Presto D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Ikan/Ikan Nila Sambal Matah D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                ...
                <!--Daging-->
                <div class="tab-pane fade show" id="pills-Daging" role="tabpanel" aria-labelledby="pills-Daging-tab"
                    tabindex="0">
                    <div class="row gy-4">
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Daging/Daging Sapi Lada Hitam D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Daging/Rendang Daging D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                ...
                <!--Nasi-->
                <div class="tab-pane fade show" id="pills-Nasi" role="tabpanel" aria-labelledby="pills-Nasi-tab"
                    tabindex="0">
                    <div class="row gy-4">
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                ...
                <!--Soto-->
                <div class="tab-pane fade show" id="pills-Soto" role="tabpanel" aria-labelledby="pills-Soto-tab"
                    tabindex="0">
                    <div class="row gy-4">
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Soto/Soto Ayam D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Soto/Soto Bandung D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Soto/Soto Banjar D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Soto/Soto Kudus D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                                        <a href="#">Soto Kudus</a>
                                    </h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Soto/Soto Makassar D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Soto/Soto Medan D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                                        <a href="#">Soto Medan</a>
                                    </h5>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Soto/Soto Padang D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                ...
                <!--Puding-->
                <div class="tab-pane fade show" id="pills-Puding" role="tabpanel" aria-labelledby="pills-Puding-tab"
                    tabindex="0">
                    <div class="row gy-4">
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Puding/Puding Coklat D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Puding/Puding Gula Melaka D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Puding/Puding Lapis D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Puding/Puding Oreo D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Puding/Puding Susu D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Puding/Puding Buah D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="menu-item bg-white shadow-on-hover">
                                <img src="./images/DU/DU Puding/Puding Roti D.jpg" alt="" />
                                <div class="menu-item-content p-4">
                                    <h5 class="mt-1 mb-2">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 intro-text">
                    ...
                    <p class="text-white">
                        To become a leading culinary destination that offers an unforgettable dining experience with
                        high-quality menus, a warm ambiance, and exceptional service.
                    </p>
                </div>
            </div>
            ...
            <div id="reviewSlider" class="carousel slide" data-bs-ride="true">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#reviewSlider"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#reviewSlider"
                    data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Next</span>
                </button>
